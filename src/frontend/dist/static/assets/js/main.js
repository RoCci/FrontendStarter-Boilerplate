...
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Button=function(){function Button(rootElement,buttonName){_classCallCheck(this,Button);this.button=rootElement.querySelector('input[name="'+buttonName+'"]');}_createClass(Button,[{key:'addClickEventListener',value:function addClickEventListener(onClick){this.button.addEventListener('click',onClick);}},{key:'addSubmitEventListener',value:function addSubmitEventListener(onSubmit){this.button.addEventListener('submit',onSubmit);}}]);return Button;}();module.exports=Button;

},{}],2:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ErrorContainer=function(){function ErrorContainer(){_classCallCheck(this,ErrorContainer);}_createClass(ErrorContainer,null,[{key:'addContainerError',value:function addContainerError(){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=document.querySelectorAll('.js-error-container')[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var container=_step.value;container.classList.remove('a-error-container--hidden');}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}}},{key:'removeContainerError',value:function removeContainerError(){var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=document.querySelectorAll('.js-error-container')[Symbol.iterator](),_step2;!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){var container=_step2.value;container.classList.add('a-error-container--hidden');}}catch(err){_didIteratorError2=true;_iteratorError2=err;}finally{try{if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}}finally{if(_didIteratorError2){throw _iteratorError2;}}}}}]);return ErrorContainer;}();module.exports=ErrorContainer;

},{}],3:[function(require,module,exports){
'use strict';require('babel-polyfill');// Adds html <picture> element to IE
require('picturefill');// Adds element.classList object to IE
require('classlist-polyfill');// Adds promises to IE
require('promise-polyfill');require('./modules/overlay');// modules
var CheckForm=require('./modules/checkForm');var checkFormElement=document.querySelector('.js-mainAuthForm');if(checkFormElement){new CheckForm(checkFormElement);}var CookieLayer=require('./modules/cookieLayer');var cookieLayerElement=document.querySelector('.js-cookieLayer');if(cookieLayerElement){new CookieLayer(cookieLayerElement);}var MainFlag=require('./modules/mainFlag');var mainFlagElement=document.querySelector('.js-mainFlagToggle');if(mainFlagElement){new MainFlag(mainFlagElement);}

},{"./modules/checkForm":4,"./modules/cookieLayer":5,"./modules/mainFlag":6,"./modules/overlay":7,"babel-polyfill":11,"classlist-polyfill":12,"picturefill":307,"promise-polyfill":309}],4:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var RestClient=require('../utilities/restClient');var Storage=require('../utilities/storage');var Button=require('../atoms/button/button');var Container=require('../atoms/error-container/error-container');var SEND_BUTTON_NAME='button_Send';var AUTH_NUMBER='Unternehmer-Abrechnungsnummer';var CheckForm=function(){function CheckForm(checkFormElement){_classCallCheck(this,CheckForm);this.checkFormElement=checkFormElement;this.restClient=new RestClient();this.formData=Storage.formData;this._initSendButton();}_createClass(CheckForm,[{key:'_initAtoms',value:function _initAtoms(){this._initSendButton();}},{key:'_initSendButton',value:function _initSendButton(){this.sendButton=new Button(this.checkFormElement,SEND_BUTTON_NAME);this.sendButton.addClickEventListener(this._click.bind(this));}},{key:'_click',value:function _click(){this._validateAuthenticationNumberAndgotoRegForm();}},{key:'_validateAuthenticationNumberAndgotoRegForm',value:function(){var _ref=_asyncToGenerator(regeneratorRuntime.mark(function _callee(){var data;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:data=666666;_context.prev=1;_context.next=4;return this.restClient.validateAuthenticationNumber(data);case 4:// window.location.href = '/thanks';
Storage.clear();_context.next=10;break;case 7:_context.prev=7;_context.t0=_context['catch'](1);// TODO ...
alert(JSON.stringify(_context.t0));case 10:case'end':return _context.stop();}}},_callee,this,[[1,7]]);}));function _validateAuthenticationNumberAndgotoRegForm(){return _ref.apply(this,arguments);}return _validateAuthenticationNumberAndgotoRegForm;}()},{key:'_initPartials',value:function _initPartials(){this._initCheckPersonalData();this._initCheckProductGroups();this._initCheckSelection();}},{key:'_initCheckPersonalData',value:function _initCheckPersonalData(){var checkPersonalDataElement=this.checkFormElement.querySelector(CHECKPERSONALDATA_CLASS);if(checkPersonalDataElement){return new CheckPersonalData();}}},{key:'_initCheckProductGroups',value:function _initCheckProductGroups(){var checkProductGroupsElement=this.checkFormElement.querySelector(CHECKPRODUCTGROUPS_CLASS);if(checkProductGroupsElement){return new CheckProductGroups();}}},{key:'_initCheckSelection',value:function _initCheckSelection(){var checkSelectionElement=this.checkFormElement.querySelector(CHECKSELECTION_CLASS);if(checkSelectionElement){return new CheckSelection();}}}]);return CheckForm;}();module.exports=CheckForm;

},{"../atoms/button/button":1,"../atoms/error-container/error-container":2,"../utilities/restClient":9,"../utilities/storage":10}],5:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var CookieLayer=function(){function CookieLayer(cookieLayerElement){_classCallCheck(this,CookieLayer);this.cookieLayerElement=cookieLayerElement;this._addCookieLayer();this._setCookie();}_createClass(CookieLayer,[{key:'_addCookieLayer',value:function _addCookieLayer(){if(document.cookie.indexOf('MBLPP_cookieAccept')!==-1){$('#cookieLayer').hide();$('.overlay--bg-full').hide();}else{$('.overlay--bg').show();$('#cookieLayer').show();$('#cookieLayerCloser').show();}}},{key:'_setCookie',value:function _setCookie(){$('a#cookieLayerCloser').click(function(){document.cookie='MBLPP_cookieAccept; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/;';$('#cookieLayer').slideUp();$('.overlay--bg').hide();});}}]);return CookieLayer;}();module.exports=CookieLayer;

},{}],6:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var MainFlag=function(){function MainFlag(mainFlagElement){_classCallCheck(this,MainFlag);this.mainFlagElement=mainFlagElement;this._textToggle();}_createClass(MainFlag,[{key:'_textToggle',value:function _textToggle(){var textElementToggle=document.querySelector('.textElementToggle');var istextElementToggle=document.querySelectorAll('.js-mainFlagToggle').length;if(istextElementToggle>0){document.querySelector('.titleClickTarget').addEventListener('click',function(){if(textElementToggle.style.display==='none'){textElementToggle.style.display='block';}else{textElementToggle.style.display='none';}});}}}]);return MainFlag;}();module.exports=MainFlag;

},{}],7:[function(require,module,exports){
'use strict';var footerLink=$('.a-link--footer');var overlayContainer=$('.metapages-page');var closeLink=$('.button-white');footerLink.on('click',function(){var overlayID=$(this).attr('data-url');document.getElementById(overlayID).style.display='block';document.getElementById('overlay').style.display='block';document.body.style.overflow='hidden';});closeLink.on('click',function(){$(overlayContainer).hide();document.getElementById('overlay').style.display='none';document.body.style.overflow='auto';});

},{}],8:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var AJAX=function(){function AJAX(){_classCallCheck(this,AJAX);}_createClass(AJAX,null,[{key:'_init',value:function _init(resolve,reject){this.xhttp=new XMLHttpRequest();this.xhttp.withCredentials=true;if(this._supportsJson()){this._initHandler(resolve,reject);}else{this._initLegacyHandler(resolve,reject);}}},{key:'_supportsJson',value:function _supportsJson(){try{// some browsers throw when setting `responseType` to an unsupported value
this.xhttp.responseType='json';return true;}catch(error){return false;}}},{key:'_initHandler',value:function _initHandler(resolve,reject){var _this=this;this.xhttp.onreadystatechange=function(){if(_this.xhttp.readyState===XMLHttpRequest.DONE){if(_this.xhttp.status===200){resolve(_this.xhttp.response);}else{reject({status:_this.xhttp.status,statusText:_this.xhttp.statusText});}}};}},{key:'_initLegacyHandler',value:function _initLegacyHandler(resolve,reject){var _this2=this;this.xhttp.onload=function(){if(_this2.xhttp.status===200){resolve(JSON.parse(_this2.xhttp.responseText));}else{reject({status:_this2.xhttp.status,statusText:_this2.xhttp.statusText});}};}},{key:'get',value:function get(url){var _this3=this;return new Promise(function(resolve,reject){_this3._init(resolve,reject);_this3.xhttp.open('GET',url);_this3.xhttp.send();});}},{key:'post',value:function post(json){var _this4=this;return new Promise(function(resolve,reject){_this4._init(resolve,reject);_this4.xhttp.open('POST',json.url);_this4.xhttp.setRequestHeader('Content-type','application/json');_this4.xhttp.send(JSON.stringify(json.data));});}}]);return AJAX;}();module.exports=AJAX;

},{}],9:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var AJAX=require('./ajax.js');var config={// serverDomain: 'http://stage-web-lp-trapo-mbvd-de.pixelpark.net:8082'
serverDomain:'http://mbvd-lpp.local:8080'};var RestClient=function(){function RestClient(){var _this=this;_classCallCheck(this,RestClient);this.baseUrl=config.serverDomain+'/lpp';// only use this for temporary testing the connection the backend service
_asyncToGenerator(regeneratorRuntime.mark(function _callee(){var healthstatus,version;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.prev=0;_context.next=3;return _this._getHealthstatus();case 3:healthstatus=_context.sent;console.log(healthstatus);_context.next=7;return _this._getVersion();case 7:version=_context.sent;console.log(version);_context.next=14;break;case 11:_context.prev=11;_context.t0=_context['catch'](0);console.error(_context.t0);case 14:case'end':return _context.stop();}}},_callee,_this,[[0,11]]);}))();}_createClass(RestClient,[{key:'validateAuthenticationNumber',value:function(){var _ref2=_asyncToGenerator(regeneratorRuntime.mark(function _callee2(data){var response;return regeneratorRuntime.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.prev=0;_context2.next=3;return AJAX.post({url:this.baseUrl+'/hermes/checkAuthenticationNumber',data:data});case 3:response=_context2.sent;return _context2.abrupt('return',this._getResponsePromise(response));case 7:_context2.prev=7;_context2.t0=_context2['catch'](0);console.error(_context2.t0);case 10:case'end':return _context2.stop();}}},_callee2,this,[[0,7]]);}));function validateAuthenticationNumber(_x){return _ref2.apply(this,arguments);}return validateAuthenticationNumber;}()},{key:'subscribeUser',value:function(){var _ref3=_asyncToGenerator(regeneratorRuntime.mark(function _callee3(data){var response;return regeneratorRuntime.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.prev=0;_context3.next=3;return AJAX.post({url:this.baseUrl+'/subscribe',data:data});case 3:response=_context3.sent;return _context3.abrupt('return',this._getResponsePromise(response));case 7:_context3.prev=7;_context3.t0=_context3['catch'](0);console.error(_context3.t0);case 10:case'end':return _context3.stop();}}},_callee3,this,[[0,7]]);}));function subscribeUser(_x2){return _ref3.apply(this,arguments);}return subscribeUser;}()},{key:'_getVersion',value:function(){var _ref4=_asyncToGenerator(regeneratorRuntime.mark(function _callee4(){return regeneratorRuntime.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.prev=0;return _context4.abrupt('return',AJAX.get(this.baseUrl+'/getVersion'));case 4:_context4.prev=4;_context4.t0=_context4['catch'](0);console.error(_context4.t0);case 7:case'end':return _context4.stop();}}},_callee4,this,[[0,4]]);}));function _getVersion(){return _ref4.apply(this,arguments);}return _getVersion;}()},{key:'_getHealthstatus',value:function(){var _ref5=_asyncToGenerator(regeneratorRuntime.mark(function _callee5(){return regeneratorRuntime.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:_context5.prev=0;return _context5.abrupt('return',AJAX.get(this.baseUrl+'/healthStatus'));case 4:_context5.prev=4;_context5.t0=_context5['catch'](0);console.error(_context5.t0);case 7:case'end':return _context5.stop();}}},_callee5,this,[[0,4]]);}));function _getHealthstatus(){return _ref5.apply(this,arguments);}return _getHealthstatus;}()},{key:'_getResponsePromise',value:function _getResponsePromise(response){return new Promise(function(resolve,reject){if(response.validationErrors){reject(response.validationMessages);}else{resolve(response.validationBody);}});}}]);return RestClient;}();module.exports=RestClient;

},{"./ajax.js":8}],10:[function(require,module,exports){
'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Storage=function(){function Storage(){_classCallCheck(this,Storage);}_createClass(Storage,null,[{key:'clear',value:function clear(){localStorage.clear();}},{key:'_getElement',value:function _getElement(elementName){return JSON.parse(localStorage.getItem(elementName));}},{key:'_setElement',value:function _setElement(elementName,value){localStorage.setItem(elementName,JSON.stringify(value));}},{key:'formData',get:function get(){return this._getElement('formData');},set:function set(value){this._setElement('formData',value);}}]);return Storage;}();module.exports=Storage;
...
},{"core-js/fn/regexp/escape":13,"core-js/shim":306,"regenerator-runtime/runtime":310}],12:[function(require,module,exports){
/*
